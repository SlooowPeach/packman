...
/// <summary>
/// Класс игрока, в котором прописаны кадры и позиции Пакмана
/// </summary>
class Player 
{
public:
	...
	/// <summary>
	/// Метод класса, в котором описана механика движения игрока
	/// </summary>
	void update() 
	{
		frame += 0.01;
...
/// <summary>
/// Класс, в котором прописаны кадры и позиции врагов
/// </summary>
class Enemy 
{
public:
	...
	/// <summary>
	/// Метод класса, в котором прописана механика движения врагов
	/// </summary>
	void update() 
	{
		ti++;
...
{
	srand(time(0));
	RenderWindow window(VideoMode(W * ts, H * ts), "Packman");

	Texture t;
	t.loadFromFile("D:/Desktop/учеба/Прога/3сем/курсовая 3 семестр/Paint/title.png");
	Sprite plat(t);

	Texture yw;
	yw.loadFromFile("D:/Desktop/учеба/Прога/3сем/курсовая 3 семестр/Paint/youwin.png");
	Sprite youwin(yw);
	youwin.setPosition(100, 210);

	Texture yl;
	yl.loadFromFile("D:/Desktop/учеба/Прога/3сем/курсовая 3 семестр/Paint/youlose.png");
	Sprite youlose(yl);
